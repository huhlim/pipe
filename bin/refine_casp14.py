...
def main():
    ...
    import_module("equil").prep(
        job,
        0,
        [out[0] for out in locPREFMD_out],
    ...
    # average
    import_module("average").prep(
        job,
        "%s.casp12.prod_0" % job.title,
        [0],
