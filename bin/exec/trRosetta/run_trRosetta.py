...
def merge(npz0, npz1, domain):
    ...
    for feature in FEATUREs:
        npz2[feature][mask] = w_3d * npz1[feature] + (1.0 - w_3d) * npz0[feature][mask]
    #
    ...
    if npz0_global_acc > npz2_global_acc:
        ...
        sys.stdout.write(
            "MERGE: %-12s  %6.4f %6.4f -> %6.4f %6.4f\n"
            % (domain.name, npz0_global_acc, npz0_local_acc, npz2_global_acc, npz1_local_acc)
        )
        return npz2
