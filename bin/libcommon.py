...
TBM_EXCLUDE = None
HH_sequence_database = "/feig/s1/huhlim/db/hhsuite/uc30/current/uc30"
HH_pdb70_database = "/feig/s1/huhlim/db/hhsuite/pdb70/current/pdb70"
    ...
    def get_task(self, method, host=None, status=None, not_status=None):
        ...
        for i, task in enumerate(self.task[method]):
            ...
            if host is not None and (
                task["resource"][1] != host and task["resource"][1].split("/")[0] != host
            ):
                continue
